package com.pug.zixun.common.utils.fn.asserts;
...
import com.pug.zixun.common.utils.fn.inter.*;
...
public class Vsserts {
     ...
     *
     * @param object
     * @param adminResultInterface
     */
    public static void isNullEx(@Nullable Object object, AdminResulInterface adminResultInterface) {
        if (object == null) {
            throw new PugValidatorException(adminResultInterface);
        }
    }
     ...
     * @param adminResultInterface
     */
    public static void isNotNullEx(@Nullable Object object, AdminResulInterface adminResultInterface) {
        if (object != null) {
            throw new PugValidatorException(adminResultInterface);
        }
    }
     ...
     * @param adminResultInterface
     */
    public static void isEmptyEx(@Nullable String content, AdminResulInterface adminResultInterface) {
     ...
     * @param adminResultInterface
     */
    public static void isFalseEx(@Nullable boolean isflag, AdminResulInterface adminResultInterface) {
        if (!isflag) {
            throw new PugValidatorException(adminResultInterface);
        }
    }
     ...
     * @param adminResultInterface
     */
    public static void isTrueEx(@Nullable boolean isflag, AdminResulInterface adminResultInterface) {
        if (isflag) {
            throw new PugValidatorException(adminResultInterface);
        }
    }
     ...
     * @param adminResultInterface
     */
    public static void isCollectionNullEx(@Nullable Collection collection, AdminResulInterface adminResultInterface) {
